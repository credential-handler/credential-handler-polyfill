...
export async function load(options = {
  ...
  // container; exposed both on the returned polyfill (`polyfill.chapi`) and
  // as a global (`navigator.chapi`) so callers can use either without
  // composing a full request object themselves
  const chapi = {
